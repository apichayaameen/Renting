...
export class RentingComponent implements OnInit {
  ...
  save() {
    this.httpClient.post('http://localhost:8080/renting/' +this.views.selectProductID + '/' + this.views.selectProductName + '/' +this.views.selectProductPrice + '/' + this.customerID + '/' + this.staffIDs + '/' + this.pipe.transform(this.ReserveDate, 'dd:MM:yyyy') + '/'
